...
./reconstruct -train ../../newWordNet/newnumEL.txt -output newdense.txt -depth 2 -k-max 1000
./line -train newdense.txt -output vec_1st_wo_norm.txt -binary 1 -size 128 -order 1 -negative 5 -samples 100 -threads 40
./line -train newdense.txt -output vec_2nd_wo_norm.txt -binary 1 -size 128 -order 2 -negative 5 -samples 100 -threads 40
...
./concatenate -input1 vec_1st.txt -input2 vec_2nd.txt -output new_vec_all.txt -binary 0
